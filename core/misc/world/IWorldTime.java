...
public interface IWorldTime {
	...
	/**
	 * The number of timer tick events per day. This must be a divisor of
	 * {@link #DAY_LENGTH} to avoid rounding issues.
	 */
	...
	/**
	 * World time starts at midnight of the first day being 0, midnight of the
	 * second day being 1 and so on.
	 *
